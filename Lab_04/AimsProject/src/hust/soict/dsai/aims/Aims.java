...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        // Adding DVDs
        Media dvd1 = new hust.soict.dsai.aims.media.DigitalVideoDisc(1, "Inception", "Science Fiction", "Christopher Nolan", 148, 19.99f);
        store.addMedia(dvd1);

        Media dvd2 = new hust.soict.dsai.aims.media.DigitalVideoDisc(2, "The Dark Knight", "Action", "Christopher Nolan", 152, 17.99f);
        store.addMedia(dvd2);
        ...
        Media book3 = new Book(9, "Educated", "Memoir", 16.95f);
        store.addMedia(book3);

        Media book4 = new Book(10, "Becoming", "Autobiography", 22.99f);
